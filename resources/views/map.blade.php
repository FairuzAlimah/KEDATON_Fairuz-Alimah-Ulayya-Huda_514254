...
@section('styles')
    ...
    <style>
        ...
        .popup-btn-edit {
            ...
            /* ini override warna biru default link */
            text-decoration: none;
        }

        .popup-btn-edit:hover {
            background: #d97706;
            color: #F3EDC8 !important;
        }
            ...
            <div class="legend-content">
                ...
                <div id="legend-jalan" class="legend-section">
                    ...
                    <div class="legend-item">
                        <img
                            src="http://localhost:8080/geoserver/responsi_pgwl/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&LAYER=responsi_pgwl:jalan">
                    </div>
                </div>
                ...
                <div id="legend-admin" class="legend-section">
                    ...
                    <div class="legend-item">
                        <img
                            src="http://localhost:8080/geoserver/responsi_pgwl/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=30&HEIGHT=30&LAYER=responsi_pgwl:area_balam">
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <div class="popup-card">
        ...
        <div class="popup-body">
            ...
            <div class="popup-actions d-flex gap-2 mt-2">
                <!-- Tombol Edit -->
                <div class="flex-fill">
                    <a href="/points/${props.id}/edit"
                       class="popup-btn popup-btn-edit d-flex align-items-center justify-content-center w-100 text-white text-decoration-none">
                ...
                <!-- Tombol Hapus -->
                <div class="flex-fill">
                    <form action="/points/${props.id}" method="POST"
                          onsubmit="return confirm('Yakin ingin menghapus?')" class="w-100">
                        <input type="hidden" name="_token" value="${csrfToken}">
                        <input type="hidden" name="_method" value="DELETE">
                        <button type="submit"
                                class="popup-btn popup-btn-delete d-flex align-items-center justify-content-center w-100">
                        ...
                        if (targetLayer && targetLayer.getPopup()) {
                            ...
                            setTimeout(() => {
                                ...
                                if (popup && popup.isOpen()) {
                                    ...
                                    const popupEl = popupPane.querySelector(
                                        '.leaflet-popup');

                                    if (popupEl) {
                                        const popupRect = popupEl
                                            .getBoundingClientRect();
                                        const mapRect = map.getContainer()
                                            .getBoundingClientRect();

                                        // Cek apakah popup terpotong di bagian bawah
                                        if (popupRect.bottom > mapRect.bottom - 20) {
                                            const currentCenter = map.getCenter();
                                            const offsetLat = (popupRect.bottom -
                                                    mapRect.bottom + 40) / mapRect
                                                .height *
                                                (map.getBounds().getNorth() - map
                                                    .getBounds().getSouth());
                                            map.panTo([currentCenter.lat - offsetLat,
                                                currentCenter.lng
                                            ], {
                                                animate: true,
                                                duration: 0.3
                                        ...
                                        if (popupRect.right > mapRect.right - 20) {
                                            const currentCenter = map.getCenter();
                                            const offsetLng = (popupRect.right - mapRect
                                                    .right + 40) / mapRect.width *
                                                (map.getBounds().getEast() - map
                                                    .getBounds().getWest());
                                            map.panTo([currentCenter.lat, currentCenter
                                                .lng - offsetLng
                                            ], {
                                                animate: true,
                                                duration: 0.3
